...
### [Project Page](https://ggxxii.github.io/ace-ego-hand/) | [Paper (ArXiv)](https://arxiv.org/abs/2608.20308)
...
of-sight hands. We introduce ACE-Ego-Hand, an offline clip-level framework that
extracts features via a Deterministic Clean-Latent Encoder and decodes them
with a Bidirectional Spatiotemporal Decoder. ACE-Ego-Hand recovers continuous
...
time camera intrinsics. Across five egocentric benchmarks, ACE-Ego-Hand sets a
